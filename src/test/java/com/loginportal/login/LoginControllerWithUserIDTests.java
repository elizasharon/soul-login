...
// 		User userFromDataService = new User();
// 		userFromDataService.setUserID(1L);
// 		userFromDataService.setEmailID("abc@gmail.com");
// 		userFromDataService.setPasswordHistory(new PasswordHistory(2L,
...
// 		when(restTemplate.exchange("http://localhost:8017/api/data/user/find", HttpMethod.POST, httpEntity,
...
// 		MvcResult mvcResult = mvc.perform(post("/api/login").contentType(MediaType.APPLICATION_JSON)
...
// 		userFromFrontEnd.setEmailID("elizasharonz@gmail.com");
// 		User userToBackEnd=new User();
// 		userToBackEnd.setEmailID("elizasharonz@gmail.com");
// 		Optional<User> optional = Optional.empty();

// 		HttpEntity<User> httpEntity = new HttpEntity<User>(userToBackEnd);
